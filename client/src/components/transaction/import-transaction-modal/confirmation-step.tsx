    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        {hasErrors && (
          ...
          >
            <p className="font-medium mb-2 bg-red-100 dark:bg-background sticky top-0 px-2 py-1">
              Issues found:
            </p>
      ...
      <div className="flex justify-between">
        ...
        <Button onClick={handleImport} disabled={isLoading}>
          {isLoading ? "Importinig..." : "Confirm Import"}
        </Button>
      </div>
    </div>
  );
